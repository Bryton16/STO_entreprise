...
<html>
<head>
	<title>Accueil - <?php echo PageName(); ?></title>
...
<div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/pignon.jpg" alt="Los Angeles" width="1000" height="600">
    </div>
    <div class="carousel-item">
      <img src="assets/img/banner2.jpg" alt="Chicago" class="" width="1000" height="600">
    </div>
    <div class="carousel-item">
      <img src="assets/img/banner3.jpg" alt="New York" width="1000" height="600">
    </div>
  </div>
...
<br></br>
<div align="center">
<div id="color" class="carre"><h1 class="carre"> Présentation</h1></div><hr width="30%">
<br><br>
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-4 col-sm-12 col-xs-12">
            <img style='float:left;width:400;height:200px; margin-right:10px; margin-top:-40px;' class="animated bounceInLeft" src="assets/img/banner.jpg" />
            <p class="animated bounceInRight">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vehicula erat metus, vel condimentum turpis eleifend non. Maecenas vel s
                agittis tellus, et porttitor felis. Etiam viverra, arcu et tincidunt tempus, arcu dui sollicitudin mi, eu ullamcorper ex felis sit 
                condimentum leo lacus, eget interdum quam vehicula vitae.
            </p>
        </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <img style='float:right;width:400;height:200px; margin-left:10px; margin-top:-40px; ' class="animated bounceInLeft" src="assets/img/banner.jpg" />
